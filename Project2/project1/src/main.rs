...
fn main() {
    ...
    let a:f64 = input1.trim().parse().expect("Please enter a number");

    println!("Enter value of b: ");
    io::stdin().read_line(&mut input2).expect("Failed to read line");
    let b:f64 = input2.trim().parse().expect("Please enter a number");

    println!("Enter value of c: ");
    io::stdin().read_line(&mut input3).expect("Failed to read line");
    let c:f64 = input3.trim().parse().expect("Please enter a number");
