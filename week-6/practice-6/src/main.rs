fn main() {
    ...
    let n4 = n1 +&n2 + &n3; // n2 7n3 reference is passed

    // About Electrical/Electronic
    println!("\nThe {} is informed by the aspiration to 
        train the electrical/electronic engineering proffessionals
    ...
    println!("{} is aimed at developing competent, creative,
     ...
     capable of creating value in tthe diverse fields of
     Computer Science. ",w3);
}
